...
class PendingBlogDetails extends StatefulWidget {
  @override
  _PendingBlogDetailsState createState() => _PendingBlogDetailsState();
}

class _PendingBlogDetailsState extends State<PendingBlogDetails> {
              ...
              Padding(
                ...
                child: _isLoading? spinWave():GradientButton(
                    ...
                    onPressed: ()async{
                      ...
                      articleProvider.updatePendingArticle(publicProvider.articleModel.id!).
                      then((value) {
